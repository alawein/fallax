...
**ReasonBench** evaluates language models on structured, multi-step reasoning tasks — logical deduction, mathematical proof, causal inference, and compositional planning. Designed to surface failure modes that single-turn benchmarks miss.
